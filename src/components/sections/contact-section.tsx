          ...
          <div className="flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div
                ...
                style={{ transitionDelay: "500ms" }}
              >
                <label className="mb-1 block font-mono text-xs text-foreground/60 md:mb-2">Расскажите о проекте</label>
                <textarea
                  rows={3}
                  ...
                  required
                  className="w-full border-b border-foreground/30 bg-transparent py-1.5 text-sm text-foreground placeholder:text-foreground/40 focus:border-foreground/50 focus:outline-none md:py-2 md:text-base"
                  placeholder="Тип объекта, площадь, задача..."
                />
              </div>
              ...
              >
                ...
                >
                  {isSubmitting ? "Отправка..." : "Рассчитать проект"}
                </MagneticButton>
                {submitSuccess && (
                  <p className="mt-3 text-center font-mono text-sm text-foreground/80">Заявка отправлена! Свяжемся в ближайшее время.</p>
                )}
              </div>
            </form>
          </div>
